...
- **New home:** `https://github.com/ethanolivertroy/kevin-pi`
- **New architecture:** Pi extension + Pi skill
- **Install:** `pi install https://github.com/ethanolivertroy/kevin-pi`
...
> Install the successor with `pi install https://github.com/ethanolivertroy/kevin-pi`.
